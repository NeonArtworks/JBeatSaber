...
/**
 * simple 3D viewer and mesh Created by huson on 12/1/15.
 */
public class MeshViewerDemo extends Application
{
	...
	private Group makePentagon(ArrayList<Point3D> input)
	{
		...
		int[] faces = new int[] { 0, 0, 1, 1, 2, 2, 0, 0, 2, 1, 3, 2, 0, 0, 3, 1, 4, 2 };
	 ...
	 */
	private void addMouseHanderToScene(Scene scene, Rotate cameraRotateX, Rotate cameraRotateY,
